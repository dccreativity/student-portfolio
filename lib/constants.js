...
// The roles that reach the staff side of the site.
//
// Every guard must ask this rather than testing role === "admin": the
// super admin's role is "superadmin", so an equality check locks them out
// of the very area they are meant to have the most access to.
