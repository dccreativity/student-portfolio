  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 shrink-0 bg-ink text-white/90 min-h-screen sticky top-0 px-5 py-6">
      ...
      <Link
        ...
        className={`block rounded-xl px-3 py-2.5 text-sm font-medium transition mt-2 border-t border-white/10 pt-4 ${
          pathname === "/dashboard/resume" ? "bg-clay text-white" : "hover:bg-white/10"
        }`}
      >
        📄 Resume
      </Link>
